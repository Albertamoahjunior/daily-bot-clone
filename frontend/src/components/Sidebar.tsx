...
import {  faHouse, faSmile, faStar, faSquarePollVertical,faMagnifyingGlassChart, faChartLine } from '@fortawesome/free-solid-svg-icons';
...
export const Sidebar: React.FC =() => {
    ...
    // bg-[#363538] 
    return (
        <div className="rounded-full fixed z-10 left-4 h-auto w-18  flex flex-col justify-center items-center px-8 py-8 space-y-8 bg-[#1F2937]  text-white ">
